...
Note : les formules utilisent les valeurs qui produisent le moins d’erreur, même si leur logique m’échappe. Par exemple, `0,78` produit une conversion plus fidèle que `0,7756` (`128 / 165 = 0,7757575…`). Soit le mapping de DSI entre valeurs réelles et valeurs MIDI n’est pas linéaire, soit le _Logical Editor_ de Cubase est buggé. Je n’ai pas le loisir de vérifier. 
